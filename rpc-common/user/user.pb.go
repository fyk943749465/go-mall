...
var file_user_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x32, 0x9c, 0x01, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12,
	...
	0x2d, 0x0a, 0x04, 0x73, 0x61, 0x76, 0x65, 0x12, 0x11, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x55,
	...
	0x0a, 0x0c, 0x73, 0x61, 0x76, 0x65, 0x43, 0x61, 0x6c, 0x6c, 0x62, 0x61, 0x63, 0x6b, 0x12, 0x11,
...
var file_user_proto_depIdxs = []int32{
	...
	1, // 1: user.User.save:input_type -> user.UserRequest
	1, // 2: user.User.saveCallback:input_type -> user.UserRequest
	2, // 3: user.User.getUser:output_type -> user.UserResponse
	2, // 4: user.User.save:output_type -> user.UserResponse
	2, // 5: user.User.saveCallback:output_type -> user.UserResponse
